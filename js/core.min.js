            ...
            getAjax: function (o) {
                ...
                var t = c.extend({
                    ...
                    success: function (t, e, i) {
                        ...
                        d("ParseAjax", i), f.appendContent(c(i.data), O), o.finished = !0, k(), f._setFocus(), setTimeout(function () {
                            f.wrap.addClass(_)
                                ...
                                for (var y = o, v = n; y < e.length; v += e[y].length, ++y) {
                                    ...
                                    if (!(b instanceof I)) {
                                        ...
                                        if (T) {
                                            ...
                                            z = new I(a, d ? E.tokenize(T, d) : T, m, T, f);
                                            if (b.push(z), k && b.push(k), Array.prototype.splice.apply(e, b), 1 != S && E.matchGrammar(t, e, i, y, v, !0, a), s) break
                                        } else if (s) break
                                    }
                                }
                            }
